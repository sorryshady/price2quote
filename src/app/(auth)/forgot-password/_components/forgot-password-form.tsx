...
const ForgotPasswordForm = () => {
  ...
  const submitHandler = async (data: ForgotPasswordSchema) => {
    try {
      const userResponse = await fetch(`${env.NEXT_PUBLIC_API_URL}/api/auth/forgot-password`, {
        method: 'POST',
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Enter your email to reset your password</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
