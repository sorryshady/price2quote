...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      animate={{
        backdropFilter: visible ? 'blur(10px)' : 'blur(20px)',
        boxShadow: visible
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <X className="text-black dark:text-white" onClick={action} />
  ) : (
    <Menu className="text-black dark:text-white" onClick={action} />
  )
}
